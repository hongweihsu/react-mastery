# Lab 14｜React.memo with unstable props
...
1. React.memo 做 shallow prop comparison。
2. 每次 render 建立的新 object/function reference 會比較為不同。
3. 先量測 Child 成本，再決定穩定 reference 是否值得。
...
對應概念：[13_performance](../../concepts/13_performance.md)
...
在 lab selector 選 **14-broken-memo / starter**。
