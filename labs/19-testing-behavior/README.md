# Lab 19｜Behaviour-focused testing
...
1. 測試 user 能找到的 role/name 與 visible result。
2. data-testid/class name 容易綁住 implementation。
3. 用 userEvent 模擬 interaction，async result 用 findBy/waitFor。
...
🟡 Intermediate · Intentionally broken starter

對應概念：[14_testing](../../concepts/14_testing.md)
...
在 lab selector 選 **19-testing-behavior / starter**。
