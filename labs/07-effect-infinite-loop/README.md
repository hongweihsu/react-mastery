...
1. 每次 render 建立新的 options object reference。
2. dependency changed → Effect → state update → render 形成 feedback loop。
3. 正確問題是 Effect 是否必要，而非如何欺騙 dependency array。
...
在 lab selector 選 **07-effect-infinite-loop / starter**。
