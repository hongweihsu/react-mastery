...
1. Custom Hook 抽取 behaviour，不共享同一份 state。
2. 先辨識 hook 的單一責任與 caller 需要的 API。
3. Options 太多常表示 abstraction 同時做了太多事。
...
對應概念：[08_custom_hooks](../../concepts/08_custom_hooks.md)
...
在 lab selector 選 **10-custom-hook / starter**。
