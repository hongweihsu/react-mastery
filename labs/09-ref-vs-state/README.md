...
1. Ref mutation 不會要求 React render。
2. 畫面需要更新的資料通常是 state；不影響畫面的 metadata 可用 ref。
3. 不要把 ref.current 當 declarative render source。
...
對應概念：[07_refs](../../concepts/07_refs.md)
...
在 lab selector 選 **09-ref-vs-state / starter**。
