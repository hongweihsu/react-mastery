# Lab 16｜Measure before optimizing
...
1. 慢不是由 re-render 次數單獨決定。
2. 先錄 Profiler baseline，再找實際 expensive work。
3. Optimization 後必須用同一 interaction 再測一次。
...
在 lab selector 選 **16-performance-profiling / starter**。
