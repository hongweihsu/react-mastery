# Lab 20｜State ownership refactor
...
1. 先找每份 state 的真正 readers/writers。
2. 只有需要 coordination 才 lift state。
3. 拆 component 是為了 ownership/change boundary，不是追求檔案數。
...
🟣 Senior / Interview · Intentionally broken starter

對應概念：[15_architecture](../../concepts/15_architecture.md)
...
在 lab selector 選 **20-architecture-refactor / starter**。
