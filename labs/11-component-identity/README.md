# Lab 11｜Tree position and state identity
...
1. State 由 tree position/type/key 對應，不是藏在 function 內。
2. 交換 labels 不一定交換 state identity。
3. 畫出 before/after sibling positions 再操作。
...
在 lab selector 選 **11-component-identity / starter**。
