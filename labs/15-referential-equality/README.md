# Lab 15｜Reference identity experiments
...
1. 內容相同的兩個 object 仍是不同 identity。
2. Dependency comparison 使用 Object.is。
3. 很多情況把 object 建在 Effect 內，比 useMemo 更直接。
...
在 lab selector 選 **15-referential-equality / starter**。
