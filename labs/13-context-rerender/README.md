...
1. Provider value 是新的 object 時，consumers 會接收新的 context value。
2. Context 解決傳遞，不自動縮小 update surface。
3. 用 Profiler 比較拆分前後，而不是只看 console 次數。
...
對應概念：[10_context_reducers](../../concepts/10_context_reducers.md)
...
在 lab selector 選 **13-context-rerender / starter**。
