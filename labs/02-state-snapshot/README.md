...
1. Event handler 讀到的是建立該 handler 的那次 render snapshot。
2. setter 排入下一次更新，不會修改目前 count binding。
3. 先預測 console 與畫面各顯示什麼。
...
對應概念：[03_state_rendering](../../concepts/03_state_rendering.md)
...
在 lab selector 選 **02-state-snapshot / starter**。
