# Lab 18｜Transition and responsive UI
...
1. Input update 是 urgent；大量結果更新可標為 transition。
2. Transition 不取消 request，也不是 debounce。
3. 觀察 typing responsiveness 與 pending indicator。
...
對應概念：[12_async_ui_suspense](../../concepts/12_async_ui_suspense.md)
...
在 lab selector 選 **18-async-ui / starter**。
